...
CREATE TABLE IF NOT EXISTS employees (
  ...
  leave_expected_end_date TEXT,
  leave_memo       TEXT NOT NULL DEFAULT '',
  leave_date       TEXT,
  ...
  is_social_insurance_target INTEGER NOT NULL DEFAULT 0,
  is_employment_insurance_target INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS payroll_monthly (
  ...
  employment_type_name_snapshot TEXT NOT NULL DEFAULT '',
